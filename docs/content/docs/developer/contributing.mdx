...
You need to install [yarn](https://yarnpkg.com), [rust](https://www.rust-lang.org/tools/install), and [Node.js 22.12.0 or newer](https://nodejs.org/en/download/). Additionally, if you want to run any of the dev scripts on the rust side of things, you'll need to install [bacon](https://crates.io/crates/bacon). Afterwards, run the following:
